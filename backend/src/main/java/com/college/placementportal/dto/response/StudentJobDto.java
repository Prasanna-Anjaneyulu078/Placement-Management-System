...
public class StudentJobDto {
    ...
    public StudentJobDto(Long id, String title, String company, String description, String location, String jobType, Double minCgpa, Integer eligibleSemester, Integer maxBacklogs, LocalDate expiryDate) {
        this.id = id;
        this.title = title;
